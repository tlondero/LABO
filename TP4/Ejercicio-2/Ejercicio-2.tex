...
Se calcula el error de la medición respecto del calculado mediante una simulación en LTSpice. El error va a estar dado por $\Epsilon= \frac{|V_{D_medido}-V_{D_simulado}|}{V_{D_simulado}}$.
