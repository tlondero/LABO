...
#Capacitor_relacion_entre_Z_y_fases
...
ax1.plot(frecuencia_medida, Z_calculada, "red", linestyle='-', label='Módulo de la Transferencia (Simulado)')
...
ax2.plot(frecuencia_medida, fase_calculada, "red", linestyle=':', label='Fase (Simulada)')
